document.getElementById("lists_cov").addEventListener("mouseover", (event) => {
  ...
  setTimeout(() =>{
    ...
    document.getElementById('edit_hover').style.padding = (((height_1 - height_2) / 2) + 15) + "px 0px " + (((height_1 - height_2) / 2) + 15) + "px 0px"
    document.getElementById('edit_hover').style.margin = "0px 10px 0px 10px"
